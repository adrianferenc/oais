...
console.log(user);
    ...
    return (
        <div className = 'about-page'>
            <p>The <span className = "oais-color">Online Atlas of Integer Sequences (OAIS)</span> is a love letter to Neil Sloane's <a href="http://oeis.org/">Online Encyclopedia of Integer Sequences (OEIS)</a>. </p>
            ...
            <p>An example of a sequence in the OEIS is the <a href="http://oeis.org/A000032">Lucas numbers</a>, <a href="http://oeis.org/A000032">sequence ID A000032</a>. The first few terms are:</p>
