...
export default function Sequence({ user, setUser, showIndex, sequence, width, inColor, numberModulus, colorModulus, showSequence, showTriangle }) {
  ...
  return (
    <Container className='text-center'>
      ...
      {(showSequence && sequence.sequenceId) && <div className='sequence-view'> <SequenceView showIndex={showIndex} numberModulus={numberModulus} colorModulus={colorModulus} sequence={sequence} width={width} inColor={inColor} /></div>}
